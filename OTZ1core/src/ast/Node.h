...
typedef enum NodeType
{
	...
	NODE_FUNCDEF_STMT, NODE_VARDEF_STMT, NODE_VARASS_STMT, NODE_FUNCCALL_STMT, NODE_IF_STMT, NODE_PRINT_STMT, NODE_RETURN_STMT, NODE_WHILE_STMT
};
...
#define WHILE_STMT(x) ((WhileStmt*)x)
